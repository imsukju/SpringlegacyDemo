...
import com.sj652.dao.UserDao;
import com.sj652.domain.Level;
...
import static com.sj652.service.UserServiceImpl.*;

@ExtendWith(SpringExtension.class)
@ContextConfiguration(classes = {TestServiceFactory.class})
public class UserServiceTest {

	@Autowired UserService userService;	// TxProxyFactoryBean에 의해 생성되는 프록시 클래스 오브젝트
