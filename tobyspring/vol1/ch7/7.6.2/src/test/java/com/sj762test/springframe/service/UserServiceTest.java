...
import static com.sj762.springframe.service.UserServiceImpl.* ;
...
public class UserServiceTest {
	...
	public void setUp() {	
		...
		users = Arrays.asList(
				...
				new User("erwins", "erwins", "p3", "user3@ksug.org", Level.SILVER, 60, MIN_RECCOMEND_FOR_GOLD-1),
				new User("madnite1", "madnite1", "p4", "user4@ksug.org", Level.SILVER, 60, MIN_RECCOMEND_FOR_GOLD),
				new User("green", "green", "p5", "user5@ksug.org", Level.GOLD, 100, Integer.MAX_VALUE)
				);
	}	
