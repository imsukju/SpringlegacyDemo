...
import com.sj762.springframe.dao.UserDaoJdbc;
...
//	}
    ...
    public static DataSource embeddedDatabase() {
        ...
        databasePopulator.addScript(new ClassPathResource("com/sj762/springframe/sqlservice/updatable/sqlRegistrySchema.sql"));
