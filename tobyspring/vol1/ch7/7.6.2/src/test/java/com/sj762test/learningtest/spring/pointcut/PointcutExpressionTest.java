package com.sj762test.learningtest.spring.pointcut;
...
import com.sj762.learningtest.spring.pointcut.Bean;
import com.sj762.learningtest.spring.pointcut.Target;

public class PointcutExpressionTest {
	@Test
	public void pointcut() throws Exception {
		tagetClassPointcutMatches("execution(* *(..))", true, true, true, true, true, true);
		tagetClassPointcutMatches("execution(* com.sj762.learningtest.spring.pointcut.Target.hello(..))", true, true, false, false, false, false);
		tagetClassPointcutMatches("execution(* com.sj762.learningtest.spring.pointcut.Target.hello())", true, false, false, false, false, false);
		tagetClassPointcutMatches("execution(* com.sj762.learningtest.spring.pointcut.Target.hello(String))", false, true, false, false, false, false);
		tagetClassPointcutMatches("execution(* com.sj762.learningtest.spring.pointcut.Target.meth*(..))", false, false, false, false, true, false);
		
		tagetClassPointcutMatches("execution(*  com.sj762.learningtest.spring.pointcut.Target.*(int,int))", false, false, true, true, false, false);
		tagetClassPointcutMatches("execution(*  com.sj762.learningtest.spring.pointcut.Target.*())", true, false, false, false, true, false);
		
		tagetClassPointcutMatches("execution(* com.sj762.learningtest.spring.pointcut.Target.*(..))", true, true, true, true, true, false);
		tagetClassPointcutMatches("execution(* com.sj762.learningtest.spring.pointcut.*.*(..))", true, true, true, true, true, true);
		tagetClassPointcutMatches("execution(* com.sj762.learningtest.spring.pointcut..*.*(..))", true, true, true, true, true, true);
