...
import com.sj762.springframe.sqlservice.jsonb.JsonSQLMapReader;
...
public class JsonSqlService implements SqlService {
	...
	private final JsonSQLMapReader jsonSQLMapReader;
	private SqlRegistry sqlRegistry = new HashMapSqlRegistry();


    @Autowired
    public JsonSqlService(JsonSQLMapReader jsonSQLMapReader) {
